...
const DEFAULT_PROGRAMS: ProgramItem[] = [
  ...
  { title: "TKA SD", subtitle: "Tes Kemampuan Akademik SD", description: "Persiapan khusus tes masuk SD unggulan dan sekolah favorit. Latihan soal TKA, logika dasar, dan kemampuan verbal-numerik untuk anak usia dini.", icon: "PenTool", subjects: ["Logika Dasar", "Numerik", "Verbal", "Penalaran"], color: "#059669", colorLight: "#d1fae5", waMessage: "Assalamualaikum, saya ingin mendaftarkan anak saya untuk Program TKA SD di Bimbel Al Ruumi." },
  ...
  { title: "Program TKA Islami", subtitle: "Tahsin & Tahfidz", description: "Program khusus bimbingan baca Al-Quran, tahsin, dan tahfidz. Dilengkapi dengan pembelajaran adab dan akhlak Islami sehari-hari.", icon: "Languages", subjects: ["Tahsin", "Tahfidz", "Fiqih Dasar", "Adab Islami"], color: "#d4930c", colorLight: "#fffbeb", waMessage: "Assalamualaikum, saya ingin mendaftarkan anak saya untuk Program TKA Islami di Bimbel Al Ruumi." },
];
